      ...
      <Page style={styles.body} wrap>
        ...
        <View style={styles.informationDiv}>
          <View style={styles.leftColumnSmall}>
            <Text style={styles.informationDivText}>
              Last Dive: {certifiedState?.lastDive}
            </Text>
            <Text style={styles.informationDivText}>
              Depature Date: {certifiedState?.depDate}
            </Text>
          </View>
          <View style={styles.rightColumnSmall}>
            <Text style={styles.informationDivText}>
              Total Dives: {certifiedState?.totalDives}
            </Text>
          </View>
        </View>
        ...
        <Text style={styles.title}>
          Diver Medical Test| Participant Questionnaire
        </Text>
