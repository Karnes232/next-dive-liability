  ...
  return (
    <Layout>
      <main className="min-h-screen flex flex-col justify-center items-center mx-5 lg:w-3/4 max-w-4xl lg:mx-auto">
        <HotelSelectButton hotel='Barcelo Palace Deluxe' image={barcelo} link='/barcelo'/>
        <HotelSelectButton hotel='Majestic Elegance' image={majestic} link='/majestic' />
        <HotelSelectButton hotel='Lopesan Costa Bavaro' image={lopesan} link='/lopesan' />
        <HotelSelectButton hotel='Occidental Caribe' image={oc} link='/oc' />
        <HotelSelectButton hotel='Occidental Punta Cana' image={op} link='/op' />
      </main>
    </Layout>
  )
}
